    ...
    return (
        <>
            <section className='lg:h-[90dvh] overflow-hidden relative'>
                ...
                <div className='absolute w-full top-[0%] left-[0%] z-10 lg:hidden'>
                    <img className='w-full' src="/images/bg-intro-mobile.svg" alt="easybank banner image" />
                </div>
            </section>
            <div className='hidden lg:block absolute -top-10 -right-40 z-20'>
                <img src="/images/image-mockups.png" alt="easybank banner image" />
            </div>
        </>
    )
}
